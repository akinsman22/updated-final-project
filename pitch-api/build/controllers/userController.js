...
exports.getUser = exports.signUser = exports.registerUser = exports.allUsers = void 0;
...
const signUser = async (req, res, next) => {
    ...
    if (validUser) {
        let matchPass = await (0, auth_1.comparePass)(req.body.password, validUser.password);
        if (matchPass) {
